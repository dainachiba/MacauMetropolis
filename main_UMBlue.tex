...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
{
\usebackgroundtemplate{\includegraphics[height=\paperheight]{figures/Desktop-Wallpapers/Desktop Wallpaper (ver 1).jpg}}
\frame{

\color{white} \large
We can insert a background image like this.\\
(source: \href{https://www.um.edu.mo/about-um/identity/}{um.edu.mo/about-um/identity/})
...
\begin{equation*}
p(\theta | x) \propto 
	\highlightcap<2->[UMRed]{p(x | \theta)}{\footnotesize Likelihood}
	~\times~
	\highlightcap<2->[UMLightBlue]{p(\theta)}{\footnotesize Prior}
\end{equation*}
...
\begin{tikzpicture}
    ...
    \node (3) [visible on=<3->] at (2,0) {\bf{\color{UMLightBlue} State B arms}};
    \node (4) [visible on=<4->,text width=3cm, align=center] at (0,2) {\bf{\color{UMRed} State A feels\\[.1em] insecure}};
	...
	\path (3) edge[line width=1.5, bend left = 40,visible on=<4->, color=UMLightBlue] (4);
	\path (4) edge[line width=1.5, bend left = 40,visible on=<5->, color=UMRed] (1);
\end{tikzpicture}
\end{center}
